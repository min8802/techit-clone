import CLD from "/images/image1.webp";
...
const TopBanner = ({setIsViewed}) => {
  ...
  return (
    <div className="h-[42px] bg-[#ff7711] flex items-center">
      <div className="bg-red-100 max-w-screen-xl mx-auto w-full px-[10px] text-sm font-medium md:text-base md:font-semibold flex justify-between items-center">
